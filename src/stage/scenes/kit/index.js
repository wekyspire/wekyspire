...
import { P, PALETTES, setTheme, getTheme, shade, desatColor, LIGHT_DESAT } from './palette.js';
import {
...
export { P, PALETTES, setTheme, getTheme, shade, desatColor, LIGHT_DESAT };
...
export const K = Object.freeze({
  box, cyl, cone, prism, lathe, sphereLo, plate,
  tilt, jitter, chip, mirror, scaleXYZ, aim, put, grp, paint, gradeY, paintNeutral,
  shade, desatColor, createRng, scatter, mergeStatic, materialOf,
});
