...
const TEMPLATES = [
  ...
  { id: 'slimeNest', name: '黏巢', cost: 3, minFloor: 2, maxFloor: 3, once: true,
    slots: [{ fixed: 'slime' }, { fixed: 'slimeletA' }] },
  { id: 'hazardCargo', name: '危险货运', cost: 4, minFloor: 2, maxFloor: 4, once: true,
    slots: [{ fixed: 'blastPod' }, { fixed: 'slimeletA' }, { fixed: 'slimeletB' }] },
  { id: 'thornPath', name: '荆棘小径', cost: 5, minFloor: 3, maxFloor: 5, once: true,
    slots: [{ fixed: 'hedgehog' }, { fixed: 'thornWeed' }, { fixed: 'slimeletA' }] },
  ...
  { id: 'toadPool', name: '蛤蟆漩涡', cost: 7, minFloor: 4, maxFloor: 7, once: true, excl: ['greatToadPool'],
    slots: [{ fixed: 'pufferToadA' }, { fixed: 'pufferToadB' }, { fixed: 'pufferToadC' }] },
