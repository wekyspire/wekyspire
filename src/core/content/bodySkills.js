...
// 常规档：基础 9 伤（2026-09-26 稿 7→9）；后手 +bonus 且抽 draw 张（结算读 isLastHandCardAtPlay 出牌时点口径）
...
// 虚形拳（S，抽牌线顶点）：无基础伤害——后手：抽7（2026-09-26 稿：抽满手牌 → 抽7）。
...
// 只经造牌指令入场，不入奖励池。（2026-09-26 稿：5 → 6；2026-09-20 用户裁决原为
// 7 → 5——单张收益压在白板拳之下，「免费」换来的额度只够磨刀。）
