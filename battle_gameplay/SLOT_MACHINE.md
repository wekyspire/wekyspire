...
每个老虎机房间内的roll初始为5金一次，roll一次后价格上涨3金（2026-09-21 大调 D4-a，自 +6 降——粉碎换金兼负删卡主渠道），但出现大奖的概率也会随之提升。每次进房免费赠送 2 抽（2026-09-21 D5；免费抽照常计入涨价以外的全部计数）。
...
如果你进入房间后，拉了四次或以上杆且从来没中奖（2026-09-21 D5 自 2 次收紧），离开房间时，老虎机会送给你一听可乐或一个鸡腿（自选）。可乐能回复4生命并在下一场战斗开始时为你额外恢复1魏启。鸡腿能恢复9生命并增加1你最大生命值。
...
你可以在银行机存款，存款可选三档：33%、66%、全部（按持有金币取整；2026-09-21 定）。每过一层，连击数+1。利率每层结算，和连击数有关。
